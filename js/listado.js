...
Listado.prototype.buscarRestaurante = function(id) {
    ...
    var restaurante = this.restaurantes.find(function(elemento) {
...
Listado.prototype.obtenerCiudades = function() {
    ...
    var ciudadesSinRepetidos = this.sinRepetidos(ciudades);
...
Listado.prototype.obtenerRubros = function() {
    ...
    var rubrosSinRepetidos = this.sinRepetidos(rubros);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var horarios = [];
    arregloHorarios.forEach(function(elemento) {
        elemento.forEach(function(hora) {
            horarios.push(hora)
        });
    });

    var horariosSinRepetidos = this.sinRepetidos(horarios);
...
//Funcion agregada
Listado.prototype.sinRepetidos = function(elementos) {
